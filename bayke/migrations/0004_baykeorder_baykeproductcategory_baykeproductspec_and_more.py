...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('bayke', '0003_alter_baykearticle_options_baykearticle_category_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cates', models.ManyToManyField(blank=True, to='bayke.baykeproductcategory', verbose_name='商品分类')),
                ('site', models.ForeignKey(blank=True, editable=False, help_text='关联站点，如果选择，该信息仅在指定站点显示', null=True, on_delete=django.db.models.deletion.CASCADE, to='sites.site')),
            ],
            options={
